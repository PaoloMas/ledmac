...
%Lorsque \np[Jean-Marc]{Marc} vit les apôtres qui s'avançaient d'un même mouvement %%% verifier sur quoi porte le ὁμόσε
...
%\reprise{prenant} prenant donc \bible{Ac|15:39}{\np[Jean-Marc]{Marc}, il navigua jusqu'à \nl{Chypre}},
...
%\reprise{PierreRome}\ctrad{Quittant}{\lit{levant l'ancre}.} la région de \nl{Chypre}, \np[Jean-Marc]{Marc} alla auprès de \np{Paul} à \nl{Ephèse}
...
%Et après avoir imposé les mains à \np[Jean-Marc]{Marc}, à très juste titre il l'envoya 
...
%\enquote{la \biblefr{parole que moi je te prescrit aujourd'hui, prend} précieusement \biblefr{soin} de la \bible{Dt|13:1}{mettre en pratique, tu n'y ajoutera ni n'y enlèvera rien}.}
...
%Car lorsqu'on exhorta  l'évêque de \nl{Salamine} à se rendre à la capitale, et à ce qu'il soit jugé face aux \npe{Antiochiens} devant le patriarche œcuménique, il fut engourdi par  à la peur, redoutant les machinations du Foulon\indexnp[le foulon][]{Pierre} : 
%\np{Anthémios} était l'admirable homme, comme il était tous à fait très orthodoxe et illuminé par  une vie sans tâche\bibleall{Sg|4:9}, très faible dans la dialectique avec les opposants,
...
%\enquote{Pourquoi es-tu chagriné, évêque, quelle est cette indifférence qui t'enveloppe et \bible{Gn|4:6}{pourquoi ton visage est-il abattu ?}
%Tu ne souffriras d'aucune méchanceté des adversaires.}
%Et ayant dit cela, il s'éloigna de lui.
%L'évêque  s'étant réveillé avec peur, tomba sur la face avec beaucoup de larmes et \ctrad{demanda}{\lit{demandait}.} à Dieu : 
%\enquote{Seigneur \np{Jésus}-Christ, \bible{Mt|16:16}{Fils du Dieu vivant},
%si toi tu ménages cette Église --- et je sais que tu la ménages ---
%et si cette vision vient d'auprès de toi, juge convenable que \ctrad{la vision}{terme différent mais synonyme du précédent.} ait lieu une seconde et une troisième fois, afin que je sois assuré que toi tu es avec moi.}
...
%Tu ne souffriras d'aucun mal de tes adversaires, car à travers moi, son serviteur, Dieu sera ton bouclier\bibleall{Gn|15:1}.}
...
%Et lorsque tes adversaires plaideront en disant en \ctrad{long et en large}{\lit{de haut en bas}.} 
%que le siège d'\nl{Antioche} est apostolique, toi aussi plaide-leur en retour : \enquote{Mon siège est aussi apostolique et j'ai un apôtre dans ma patrie.}}
%
...
%Le bienheureux \np{Anthémios}, un petit évêque, rétorqua : \enquote{
...
% pour les \npe{Chypriotes} de \nl{Constantia} au mois de Mésore, qui est aussi le \ctrad{dixième}{le \textgreek{τοῦ καὶ δεκάτου} est de sens obscure. Nous avons traduit selon le plus probable, mais le mois de Mésore est le onzième dans le calendrier Égyptien.}, le \ctrad{onzième jour}{4 août.} %% Egyptiens 4 aout, Constantia = salamine -> manque bout de traduction
